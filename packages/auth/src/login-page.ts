 ...
 */
// eslint-disable-next-line sonarjs/cognitive-complexity -- Complex HTML template generation with conditional styling
  ...
  <body>
    <div class="login-container">
      ...
      <div class="provider-buttons">
        ${/* eslint-disable-next-line sonarjs/no-nested-conditional -- Complex OAuth URL parameter building */
