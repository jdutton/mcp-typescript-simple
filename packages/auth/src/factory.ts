...
export class OAuthProviderFactory implements IOAuthProviderFactory {
  ...
  createProvider(config: OAuthConfig): OAuthProvider {
    switch (config.type) {
      case 'google':
        return this.registerProvider(new GoogleOAuthProvider(config as GoogleOAuthConfig, this.sessionStore, this.pkceStore));

      case 'github':
        return this.registerProvider(new GitHubOAuthProvider(config as GitHubOAuthConfig, this.sessionStore, this.pkceStore));

      case 'microsoft':
        return this.registerProvider(new MicrosoftOAuthProvider(config as MicrosoftOAuthConfig, this.sessionStore, this.pkceStore));

      case 'generic':
        return this.registerProvider(new GenericOAuthProvider(config as GenericOAuthConfig, this.sessionStore, this.pkceStore));
