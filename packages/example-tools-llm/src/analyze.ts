/**
 * Analyze tool - Deep text analysis with multiple AI providers
 *
 * Example tool demonstrating:
 * - Analysis type selection (sentiment, themes, structure, etc.)
...
export type AnalyzeToolInput = z.infer<typeof AnalyzeToolZodSchema>;
